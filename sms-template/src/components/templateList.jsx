...
function TemplateList() {
  ...
  const fetchTemplates = async () => {
    try {
      const response = await axios.get(`${API_URL}/api/app/sms-sablon`, {
        headers: {
  ...
  const getToken = () => {
    return "eyJhbGciOiJSUzI1NiIsImtpZCI6IjRGOTY5MUQyMDk3RUExQ0QxODk5REZFRDg5QzM5NUNBQ0VENTQzQTkiLCJ4NXQiOiJUNWFSMGdsLW9jMFltZF90aWNPVnlzN1ZRNmsiLCJ0eXAiOiJhdCtqd3QifQ..SyQj-Cm0uyUQM9mMIuatv4miFBY9qh6TRnnutgOugaLcOyvu2lecNRKfPU-qYpCZlH6oWIJjq89_5bletlII3K9UVFX685jTg9ZxcSA9osILqm0lSphCP5A_6r9hFV3LVtlO_MvnyW8W35aMTyS80ium9n8999KCX8FMfYCj80AScJECUp2Qaqdjhd-zW9I1sGCMEjoJGaBnNGNQkRjqH3ssCpFqfJpuDIjjP7-AItuJGRibdRej_PrVhn6dSBn4n5WFpGraFEVeb1fJ4Bx2RHljVNAVsOdo7nbGV2DgPqMVfRyDchR6izzADSwWhTnG1V8olGwhFCq--ADvGI7V1A";
  };
